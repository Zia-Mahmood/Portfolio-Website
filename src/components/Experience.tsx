...
const experiences = [
  {
    ...
    achievements: [
      'Assisted in conducting tutorials and doubt-clearing sessions for core ML concepts.',
  ...
  },
  {
    ...
    image: 'logos/hexagon-logo.jpg',
    period: 'Jan 2024 – May 2024',
    location: 'Hyderabad, India · On-site',
    description:
      'Worked as a Software Engineer Intern on internal enterprise applications and reporting systems. Contributed to backend logic, reporting pipelines, and frontend integrations in a production environment.',
    achievements: [
      'Developed core application functionality using C# and the .NET Framework.',
      'Designed and implemented SSRS reports with database mappings for client-facing analytics.',
      'Improved data accessibility and reporting workflows through structured backend logic.',
      'Collaborated with senior engineers and frontend developers on a React-based internal tool.',
    ],
    technologies: [
      'C#',
      '.NET Framework',
      ...
      <div className="section-container">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Academic and industry experience focused on teaching, systems, and real-world software development.
          </p>
        </motion.div>
