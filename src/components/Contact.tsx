      ...
      <div className="section-container relative z-10">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Have a project in mind or want to discuss job opportunities? I'd love to hear from you!
          </p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
          ...
          >
            ...
            <div className="space-y-6">
              <a
                href="mailto:ziamh2003@gmail.com"
              ...
              >
                ...
                <div>
                  ...
                  <p className="font-medium group-hover:text-primary transition-colors">ziamh2003@gmail.com</p>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  ...
                  <p className="font-medium group-hover:text-primary transition-colors">+91 9381235505</p>
                </div>
              </a>
            ...
            <div className="mt-8">
              ...
              <div className="flex gap-3">
                <a href="https://www.linkedin.com/in/zia-mahmood-hussain/" target="_blank" rel="noopener noreferrer" className="social-icon">
                  <Linkedin size={20} />
                </a>
                <a href="https://github.com/Zia-Mahmood" target="_blank" rel="noopener noreferrer" className="social-icon">
                  <Github size={20} />
                </a>
